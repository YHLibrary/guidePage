...
//    self.pageControl.currentPageIndicatorTintColor = RGB(105, 105, 105);
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:105.0/255 green:105.0/255 blue:105.0/255 alpha:1];
    ...
    self.enterButton.layer.borderColor = [UIColor colorWithRed:105.0/255 green:105.0/255 blue:105.0/255 alpha:1].CGColor;
    self.enterButton.layer.cornerRadius = 5;
    self.enterButton.layer.masksToBounds = YES;

    [self.enterButton setTitleColor:[UIColor colorWithRed:105.0/255 green:105.0/255 blue:105.0/255 alpha:1] forState:UIControlStateNormal];
